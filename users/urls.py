...
from users.views import SignUpCreateAPIView, CodeVerifiedAPIView, UserUpdateAPIView, LoginView, LogoutView, \
    RefreshTokenView, ResendVerifyCodeAPIView, UpdateAvatarAPIView, ForgetPasswordView
