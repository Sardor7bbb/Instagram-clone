...
from posts.views import PostListView, PostCommentListView, PostCreateAPIView, PostCommentCreateAPIView, PostLikeAPIView, CommentLikeAPIView, PostUpdateAPIView, CommentUpdateAPIView, PostDeleteAPIView
...
urlpatterns = [
    ...
    path('<int:pk>/comments/update/', CommentUpdateAPIView.as_view(), name='update-comment'),
]
